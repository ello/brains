...
let AUTH_DOMAIN
let AUTH_CLIENT_ID
let DIALOG_RENDERABLES
let ERROR_RENDERABLES
let PROMO_HOST
...
export const setDialogRenderables = (renderables: any) => (DIALOG_RENDERABLES = renderables)
